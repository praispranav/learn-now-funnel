...
@Component({
  selector: 'app-home',
  imports: [LandingCardComponent, TopCompaniesComponent, WhyLearnNowComponent, ProgramCheckComponent, PainPointComponent, JobPlacementComponent, FullStackProgramComponent, WhatYouLearnComponent, OurProgramComponent, RoadmapComponent, JobRolesComponent, SalaryAlumniComponent, PricingCertificationComponent, GuaranteeSuccessComponent, WorkExperienceComponent, InstructorsComponent, TestimonialsComponent, FaqComponent, CtaComponent, FooterComponent],
